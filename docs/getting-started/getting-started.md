...
description: The following topics are designed to help you get started using the Strategy REST API.
---

To get started, view the following topics to know the basics of the Strategy REST API:

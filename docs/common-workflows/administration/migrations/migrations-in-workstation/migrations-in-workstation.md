...
description: You can use REST API requests to create and import migration packages just as the Workstations does. This way all packages are managed by the Strategy Storage Service and the migration processes can be monitored in Workstation.
---

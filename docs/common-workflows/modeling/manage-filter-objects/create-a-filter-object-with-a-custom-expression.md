---
title: Create a filter object with a custom expression
...
1. [Create a new filter using a custom expression with `POST /api/model/filters`.](#create-a-new-filter-using-a-custom-expression-with-post-apimodelfilters)
...
## Create a new filter using a custom expression with [POST /api/model/filters.](https://demo.microstrategy.com/MicroStrategyLibrary/api-docs/index.html#/Filters/ms-postFilter)

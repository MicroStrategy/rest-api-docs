...
This workflow sample is similar to [Retrieve a filter's definition](#retrieve-a-filters-definition), except with `showFilterTokens=true`.
...
Sample Response Body: You can view the filter’s definition in the body of the response. If you compare this to [Retrieve a filter's definition](#retrieve-a-filters-definition), "qualification" has an extra field of "tokens".

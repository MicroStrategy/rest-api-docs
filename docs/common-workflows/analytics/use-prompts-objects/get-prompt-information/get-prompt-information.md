...
The prompts supported in the Strategy platform are defined in EnumDSSXMLPromptType.
...
To help you get started using REST APIs to build feature-rich applications that leverage Strategy's prompt capabilities, we have provided a [workflow sample for getting a prompt definition](workflow-get-prompt-information.md).
